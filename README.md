...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/llm.py:268** - (shengguangming): maybe we can hack the autoregressive logics without only apply post process for better performance
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/llm.py:272** - (sgm): we can optimize it by making the dataloader yield List[int] without padding.
- [ ] **luffy/verl/third_party/vllm/vllm_v_0_4_2/llm.py:288** - (shengguangming): can be optimzied by rewrite the Sampler._get_logprobs() logits
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/llm_engine_sp.py:128** - (woosuk): Print more configs in debug mode.
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/llm_engine_sp.py:130** - currently is hfconfig
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:77** - add checkpoint manager
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:140** - (zhangchi.usc1992):
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:159** - Implement model loading with proper initialization context
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:160** - Add support for different model types and configurations
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:161** - Implement memory-efficient model loading for large models
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:162** - Add model validation and compatibility checks
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:165** - Complete model loading implementation
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:166** - Add support for custom model architectures
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:167** - Implement proper dtype and attention configuration
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:170** - Implement gradient checkpointing configuration
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:171** - Add memory usage optimization strategies
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:172** - Configure mixed precision training settings
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:173** - Implement FSDP sharding and wrapping policies
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:174** - Add CPU offloading configuration for memory optimization
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:175** - Set up distributed training parameters properly
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:178** - Initialize FSDP wrapped model
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:301** - add a unified tracking
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:318** - (zhangchi.usc1992) add back checkpoint manager. Currently, it blocks when uploading to hdfs. So very slow.
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:50** - Implement reward computation for different data sources
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:53** - Add support for parallel processing of reward computation
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:54** - Implement proper sequence decoding and validation
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:5** - Add support for parallel processing of reward computation
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:56** - Optimize memory usage for large batch processing
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:62** - Extract and validate prompt and response sequences
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:63** - Decode sequences to text format
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:64** - Apply appropriate reward function based on data source
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:65** - Handle edge cases and error conditions
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/main_ppo.py:70** - Implement batch-wise reward computation
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:77** - add checkpoint manager
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:140** - (zhangchi.usc1992):
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:159** - Implement model loading with proper initialization context
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:1** - Add support for different model types and configurations
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:161** - Implement memory-efficient model loading for large models
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:162** - Add model validation and compatibility checks
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:165** - Complete model loading implementation
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/trainer/fsdp_sft_trainer.py:166** - Add support for custom model architectures
